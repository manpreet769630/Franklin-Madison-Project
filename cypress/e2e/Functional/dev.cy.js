...
const sourceFile = require('../../fixtures/e2e_source_node1.json');

describe("Check the 'Enrollment' form submission", { tags: '@e2e' }, () => {
  
  sourceFile.forEach((page) => {
    it(
      `Verify 'Enrollment' form submission for the page: ${page.url} in Dev Environment`,
      { tags: '@dev_enrollment_member_info' },
      () => {
        cy.visit(page.url);
